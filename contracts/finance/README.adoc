...
- {PaymentSplitter} allows to split Ether and ERC420 payments among a group of accounts. The sender does not need to be
...
- {VestingWallet} handles the vesting of Ether and ERC420 tokens for a given beneficiary. Custody of multiple tokens can
